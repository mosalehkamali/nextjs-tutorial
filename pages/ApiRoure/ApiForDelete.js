...
function ApiForDelete() {
  return (
    <>
     <TopicContent
     text={'برای متد دلیت باید یک روت داینامیک ایجاد کنیم چون یک آیدی متغییر در api ارسال میشود و بعد به شکل زیر دیتای مدنظر را از دیتا بیس پاک میکنیم'}
